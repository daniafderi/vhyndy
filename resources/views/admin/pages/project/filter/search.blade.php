    ...
    <table>
        <thead>
            <tr>
                ...
                <th class="scat">Nama pelanggan</th>
                <th class="sprice">Status</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="scat"> {{ $project->customer_name }}</td>
                <td class="sprice">{{ $project->status->name }}</td>
                <td class="status">{{ $project->code_project }}</td>
                <td class="saction">
            ...
            @endforeach
            @else
            <tr><td style="text-align: center">Tidak ada data ditemukan</td></tr>
            @endif
        </tbody>
    </table>
    </div>
